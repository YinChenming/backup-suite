...
#pragma pack(pop)
    ...
    class BACKUP_SUITE_API ZipFile
    {
      public:
        ...
        using RC4CryptorIstreamBuf = StreamEncryptorIstreamBuf<encryption::RC4>;
      ...
      private:
        ...
        struct StringEncryptionHeader
        {
            ...
            uint16_t bit_len, flags;
        };
        static StringEncryptionHeader get_encryption_method(const std::vector<uint8_t>& extra_field);
